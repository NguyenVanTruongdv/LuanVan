...
const styles = `
  * { box-sizing: border-box; }
  ...
  .elp-textarea::placeholder { color: #94A3B8; }
  .elp-textarea:focus {
    border-color: var(--elp-accent);
    box-shadow: 0 0 0 3px var(--elp-accent-bg);
  }
...
export default function EmployeeListPageOfManager() {
    ...
    useEffect(() => {
        (async () => {
            try {
                const rawBranches = await managerApi.getBranches();
        ...
        <div className="elp-page">
            ...
            <div className="elp-wrap">
                <div className="elp-header">
                    ...
                    <button onClick={() => navigate("/manager/employees/create")} className="btn btn-primary">
                        <Plus size={16} />
                        Thêm nhân viên
                    </button>
                </div>
