...
//         public EmployeeService(GymManagementContext context, FaceIdService faceIdService)
//         {
//             _context = context;
...
//         // NOTE: CreateEmployeeDto cần thêm 2 field mới (nullable) để hỗ trợ FaceID lúc tạo:
//         //   public IFormFile? ProfileImage { get; set; }
//         //   public string? FaceIdReason { get; set; }
//         // Tạo nhân viên KHÔNG bắt buộc phải có FaceID — nếu ProfileImage null thì bỏ qua bước đăng ký face.
...
//             // FaceID là tùy chọn khi tạo nhân viên — chỉ đăng ký nếu có ảnh được gửi kèm.
...
//         // Đăng ký/cập nhật FaceID cho nhân viên (dùng cả khi chưa có và khi đã có FaceDatum).
//         // Dùng chung quyền quản lý với Update/Lock/Unlock (Admin toàn quyền, Manager giới hạn theo chi nhánh).
//         public async Task<FaceDatum> UpdateFaceAsync(long employeeId, IFormFile profileImage, string? reason, long currentEmployeeId)
//         {
...
//         // Lấy lịch sử thay đổi FaceID của 1 nhân viên
