...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> LoginEmployee([FromBody] LoginEmployeeRequestDto req)
    {
   ...
   public async Task<IActionResult> LoginMember([FromBody] LoginMemberRequestDto req)
{
